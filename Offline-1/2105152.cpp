/*Consider the class Student that has three private member variables, namely roll (integer), name (string), and
 cgpa (float). Write appropriate getter and setter functions along with overloaded constructors so the given 
 main function works properly. Also, write a destructor function that sets the roll to 0.*/
#include<iostream>
#include<cstring>
using namespace std;
